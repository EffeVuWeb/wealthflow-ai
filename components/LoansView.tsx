...
import { Plus, Trash2, CreditCard, CheckCircle, TrendingDown, AlertCircle, Calendar, Bell, BellRing, Wallet } from './Icons';
...
const LoansView: React.FC<LoansViewProps> = ({ loans, accounts, onAddLoan, onDeleteLoan, onPayInstallment }) => {
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    {loan.paymentAccountId && (() => {
                      const paymentAccount = accounts.find(a => a.id === loan.paymentAccountId);
                      return paymentAccount ? (
                        <p className="text-xs text-slate-500 flex items-center gap-1 mt-1">
                          <Wallet className="w-3 h-3" />
                          Pagato da: <span className="text-slate-400">{paymentAccount.name}</span>
                        </p>
                      ) : null;
                    })()}
                  </div>
